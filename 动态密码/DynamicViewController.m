...
@interface DynamicViewController ()<UITextFieldDelegate, NISTInPutViewDelegate>
...
- (void)btnClick2{
    ...
    NSDictionary *dict0 = [NIST1000 checkPinCode:self.passwordTextField.text];
    ...
    NSDictionary *dict = [NIST1000 getDynamicCodeWithSerialNumber:[NIST_DataSource sharedDataSource].tokenSN withUTC:realTime withConfirmationViewBlock:^{
...
- (void)dealloc{
//    [[NIST_SDK_Interface shareNISTInterface] cancelTrans];
}
